...
function gvue () {
   ...
   grep --exclude-dir={vendor,node_modules,.git,coverage,public,logs,build,.attic,playwright-report,dist} --exclude=diff --exclude=log --exclude=q.txt --exclude=package-lock.json -Ri "$1" .
	true
}
